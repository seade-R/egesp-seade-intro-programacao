...
Note que você pode escolher um arquivo na pasta local ou um URL, ou seja, um arquivo que esteja armazenado na web. Os dados da PIESP não estão no seu computador, mas no endereço do repositório do curso: <https://raw.githubusercontent.com/seade-R/seade-intro-programacao/master/data/piesp.csv>
...
``` r
piesp <- read_csv2('https://raw.githubusercontent.com/seade-R/seade-intro-programacao/master/data/piesp.csv')
```
...
``` r
url_piesp <- "https://raw.githubusercontent.com/seade-R/seade-intro-programacao/master/data/piesp.csv"
