...
``` r
piesp <- read_csv2('https://raw.githubusercontent.com/seade-R/seade-intro-programacao/main/data/piesp.csv')
```
...
``` r
url_piesp <- 'https://raw.githubusercontent.com/seade-R/seade-intro-programacao/main/data/piesp.csv'
url_piesp_virgula <- 'https://raw.githubusercontent.com/seade-R/seade-intro-programacao/main/data/piesp_virgula.csv'
url_piesp_tab <- 'https://raw.githubusercontent.com/seade-R/seade-intro-programacao/main/data/piesp_tab.txt'
url_piesp_sem_cabecalho <- 'https://raw.githubusercontent.com/seade-R/seade-intro-programacao/main/data/piesp_sem_cabecalho.csv'
